...
def callback(ch, method, properties, body):
    ...
    #Convert string to uppercase with .upper()
    originalString = str(body.decode())
    string = originalString.upper()
    logger.info(f" [x] Received {string}")

    #create CSV and write to it
    csvwriter = csv.writer(open("data_cityOutputfile.csv", "a"))
    csvwriter.writerow(zip([originalString], [string]))
...
def main(hn: str = "localhost", qn: str = "task_city"):
